...
public class ProdDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() > 0) {
            log.info("Production data already exists, skipping init.");
            return;
        }

        log.info("=== Initializing production seed data ===");

        User admin = userRepository.save(User.builder()
            .username("admin").email("admin@skillstore.com")
            .passwordHash(passwordEncoder.encode("admin123"))
            .role(UserRole.ADMIN).build());
        User author = userRepository.save(User.builder()
            .username("author").email("author@skillstore.com")
            .passwordHash(passwordEncoder.encode("author123"))
            .role(UserRole.AUTHOR).build());
        userRepository.save(User.builder()
            .username("demo").email("demo@skillstore.com")
            .passwordHash(passwordEncoder.encode("demo123"))
            .role(UserRole.USER).build());

        Category devCat = categoryRepository.save(Category.builder()
            .name("Development").slug("development").sortOrder(0).build());
        Category aiCat = categoryRepository.save(Category.builder()
            .name("AI & ML").slug("ai-ml").sortOrder(1).build());
        Category officeCat = categoryRepository.save(Category.builder()
            .name("Office Tools").slug("office-tools").sortOrder(2).build());
        Category designCat = categoryRepository.save(Category.builder()
            .name("Design").slug("design").sortOrder(3).build());
        ...
        createSkill("Claude Code Assistant", "claude-code-assistant",
        ...
        createSkill("PDF Document Processor", "pdf-document-processor",
        ...
        createSkill("Web Scraper Pro", "web-scraper-pro",
        ...
        createSkill("Security Audit Skill", "security-audit-skill",
        ...
        createSkill("UI Design Generator", "ui-design-generator",
        ...
        createSkill("Data Pipeline Manager", "data-pipeline-manager",
        ...
        createSkill("Meeting Notes AI", "meeting-notes-ai",
        ...
        createSkill("Image Editor Skill", "image-editor-skill",
        ...
        log.info("=== Prod seed data initialized: 3 users, 4 categories, 4 tags, 8 skills ===");
    }
